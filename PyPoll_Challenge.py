...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (county_total > winning_count) and (county_percentage > largest_turnout_percentage):
            largest_turnout_votes = county_total
    ...
    largest_county_results = (
        ...
        f"largest turnout votes: {largest_turnout_votes:,}\n"
